...
from quant.domain.pm.utils.tools.config import (
    ANALYSIS_START_DATE,
    ANALYSIS_END_DATE,
    ANNUAL_FACTOR,
)
from quant.domain.pm.utils.analysis.risk_metrics.components.helpers import (
    annualize_return,
    annualize_volatility,
    calculate_portfolio_returns,
)
from quant.domain.pm.utils.analysis.risk_metrics.analyzers.ratio_analyzer import RatioAnalyzer
from quant.domain.pm.utils.analysis.risk_metrics.analyzers.var_es_analyzer import VarEsAnalyzer
from quant.domain.pm.utils.analysis.risk_metrics.analyzers.drawdown_analyzer import DrawdownAnalyzer
from quant.domain.pm.utils.analysis.risk_metrics.analyzers.benchmark_analyzer import BenchmarkAnalyzer
from quant.domain.pm.utils.analysis.risk_metrics.analyzers.distribution_analyzer import DistributionAnalyzer
from quant.domain.pm.utils.analysis.risk_metrics.analyzers.correlation_analyzer import CorrelationAnalyzer
from quant.domain.pm.utils.data.data_process import DataManager
...
class RiskUseCase:
    def __init__(self):
        ...
        self.var_es_analyzer = VarEsAnalyzer()
    ...
    def analyze_complete(
        ...
        start_date = start_date or ANALYSIS_START_DATE
        end_date = end_date or ANALYSIS_END_DATE
