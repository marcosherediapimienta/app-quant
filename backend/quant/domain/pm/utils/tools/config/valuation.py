...
SECTOR_PROFITABILITY_SCORING = {
    ...
    'industrials': {
        'weights': {'roic': 0.35, 'roe': 0.20, 'operating_margin': 0.25, 'net_margin': 0.20},
        'ranges': {
            'roic': {'min': -0.05, 'max': 0.25},
            'roe': {'min': -0.05, 'max': 0.25},
            'operating_margin': {'min': 0, 'max': 0.20},
            'net_margin': {'min': 0, 'max': 0.15},
        },
        'alerts': {'roic_low': 0.06, 'operating_margin_low': 0.05, 'roe_negative': 0, 'net_margin_negative': 0},
    },
    'basic_materials': {
        'weights': {'roic': 0.30, 'roe': 0.20, 'operating_margin': 0.25, 'net_margin': 0.25},
        'ranges': {
            'roic': {'min': -0.10, 'max': 0.20},
            'roe': {'min': -0.10, 'max': 0.25},
            'operating_margin': {'min': -0.05, 'max': 0.20},
            'net_margin': {'min': -0.05, 'max': 0.15},
        },
        'alerts': {'roic_low': 0.05, 'operating_margin_low': 0.04, 'roe_negative': 0, 'net_margin_negative': 0},
    },
}
...
SECTOR_FINANCIAL_HEALTH_SCORING = {
    ...
    'consumer_defensive': {
        ...
        'ranges': {
            'debt_ebitda': {'min': 0, 'max': 4},
            'debt_equity': {'min': 0, 'max': 2.5},
            'current_ratio': {'min': 0.5, 'max': 3.0},
            'net_cash_ebitda': {'min': -2, 'max': 3},
        },
        'alerts': {
            'debt_ebitda_danger': 4,
            'debt_ebitda_warning': 3,
    ...
    'basic_materials': {
        ...
        'ranges': {
            'debt_ebitda': {'min': 0, 'max': 7},
            'debt_equity': {'min': 0, 'max': 3.5},
            'current_ratio': {'min': 0.5, 'max': 3.0},
            'net_cash_ebitda': {'min': -4, 'max': 3},
        },
        'alerts': {
...
SECTOR_EFFICIENCY_SCORING = {
    ...
    'consumer_cyclical': {
        'weights': {'asset_turnover': 0.35, 'dso': 0.30, 'dio': 0.35},
        'ranges': {
            'asset_turnover': {'min': 0.5, 'max': 2.5},
            'dso': {'min': 20, 'max': 60},
            'dio': {'min': 20, 'max': 90},
        },
        'alerts': {
    ...
    'consumer_defensive': {
        'weights': {'asset_turnover': 0.35, 'dso': 0.30, 'dio': 0.35},
        'ranges': {
            'asset_turnover': {'min': 0.5, 'max': 2.0},
            'dso': {'min': 20, 'max': 60},
            'dio': {'min': 20, 'max': 90},
        },
        'alerts': {
    ...
    'basic_materials': {
        'weights': {'asset_turnover': 0.40, 'dso': 0.30, 'dio': 0.30},
        'ranges': {
            'asset_turnover': {'min': 0.2, 'max': 1.2},
            'dso': {'min': 30, 'max': 90},
            'dio': {'min': 30, 'max': 120},
        },
        'alerts': {
