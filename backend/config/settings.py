...
_default_quant_path = str(BASE_DIR.parent.parent / 'quant')
QUANT_PROJECT_PATH = os.getenv('QUANT_PROJECT_PATH', _default_quant_path)

if QUANT_PROJECT_PATH not in sys.path:
    sys.path.insert(0, QUANT_PROJECT_PATH)

projects_path = os.path.join(QUANT_PROJECT_PATH, 'projects')
