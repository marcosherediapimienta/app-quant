...
from quant.domain.pm.utils.analysis.capm.analyzers.capm_analyzer import CAPMAnalyzer
from quant.domain.pm.utils.analysis.capm.analyzers.multi_asset_capm_analyzer import MultiAssetCAPMAnalyzer
from quant.domain.pm.utils.analysis.capm.analyzers.portfolio_optimization_analyzer import PortfolioOptimizationAnalyzer
...
class CAPMUseCase:
    def __init__(self):
        ...
        self.multi_asset_analyzer = MultiAssetCAPMAnalyzer()
        self.optimization_analyzer = PortfolioOptimizationAnalyzer()
